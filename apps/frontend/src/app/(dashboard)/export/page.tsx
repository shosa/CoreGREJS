  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={containerVariants}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">DDT Totali</p>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-green-700 dark:text-green-400">DDT Aperti</p>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-400">DDT Chiusi</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {/* 1. DDT Aperti (Continue) */}
        <motion.div variants={itemVariants}>
          <Link href="/export/continue">
            <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 dark:border-gray-800 dark:bg-gray-800/40 backdrop-blur-sm hover:-translate-y-1 cursor-pointer h-full">
              ...
              <div className="relative p-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Gestisci i documenti di trasporto aperti e continua la lavorazione
                </p>
          ...
          <Link href="/export/create">
            <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg hover:shadow-xl transition-all duration-300 dark:border-gray-800 dark:bg-gray-800/40 backdrop-blur-sm hover:-translate-y-1 cursor-pointer h-full">
              ...
              <div className="relative p-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Crea un nuovo documento di trasporto con procedura guidata (3 step)
                </p>
