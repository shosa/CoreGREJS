          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/produzione/statistics">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center rounded-lg border border-purple-300 bg-white px-4 py-2.5 text-sm font-medium text-purple-700 hover:bg-purple-50 dark:border-purple-600 dark:bg-gray-700 dark:text-purple-300 dark:hover:bg-purple-600/20 transition-colors shadow-sm"
              >
