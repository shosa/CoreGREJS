...
export default function DashboardLayout({
  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      {/* Content Area — full width, padding bottom for dock */}
      <div className="relative flex flex-col h-full overflow-x-hidden overflow-y-auto">
        {/* Header */}
        <Header />

        {/* Main Content */}
        <main className="relative flex-1 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-y-auto pb-24">
          {/* Animated Wave Background - Fixed */}
          <div className="fixed bottom-0 left-0 right-0 h-80 overflow-hidden pointer-events-none z-0">
            {/* Wave 1 - Bottom */}
